static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ECHELON_CITY_WEST - 1] = {MAP_GROUP(ECHELON_CITY_WEST), MAP_NUM(ECHELON_CITY_WEST), 25, 29},
    [HEAL_LOCATION_ECHELON_CITY_NORTH - 1] = {MAP_GROUP(ECHELON_CITY_NORTH), MAP_NUM(ECHELON_CITY_NORTH), 46, 16},
    [HEAL_LOCATION_ECHELON_CITY_EAST - 1] = {MAP_GROUP(ECHELON_CITY_EAST), MAP_NUM(ECHELON_CITY_EAST), 30, 31},
};
