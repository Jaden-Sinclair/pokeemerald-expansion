...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_QUILL_BARRAGE] = _("Quill Barrage"),
    [MOVE_BURNING_PASSION] = _("Burning Passion"),
    [MOVE_WAVECRASH_JAWS] = _("Wavecrash Jaws"),
    [MOVE_GORGE] = _("Gorge"),
    [MOVE_BLOAT_TACKLE] = _("Bloat Tackle"),
    [MOVE_FEAST] = _("Feast"),
    [MOVE_GLIMMER_SHOT] = _("Glimmer Shot"),
    [MOVE_PENDULUM_RUSH] = _("Pendulum Rush"),
    [MOVE_BONK] = _("Bonk"),
    // Max Moves
...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_QUILL_BARRAGE] = _("QuillBarrage"),
    [MOVE_BURNING_PASSION] = _("BrningPssion"),
    [MOVE_WAVECRASH_JAWS] = _("WavecrashJaw"),
    [MOVE_GORGE] = _("Gorge"),
    [MOVE_BLOAT_TACKLE] = _("Bloat Tackle"),
    [MOVE_FEAST] = _("Feast"),
    [MOVE_GLIMMER_SHOT] = _("Glimmer Shot"),
    [MOVE_PENDULUM_RUSH] = _("PendulumRush"),
    [MOVE_BONK] = _("Bonk"),
    // Max Moves
