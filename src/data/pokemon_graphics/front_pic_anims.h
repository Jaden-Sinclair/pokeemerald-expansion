...
PLACEHOLDER_ANIM_SINGLE_FRAME(SkittyCasterianFeral);
PLACEHOLDER_ANIM_SINGLE_FRAME(DelcattyCasterianFeral);
PLACEHOLDER_ANIM_SINGLE_FRAME(SkittyCasterianDomestic);
PLACEHOLDER_ANIM_SINGLE_FRAME(DelcattyCasterianDomestic);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Sharpuggle);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pokidna);
PLACEHOLDER_ANIM_SINGLE_FRAME(Arquillery);
#endif //P_FAMILY_SHARPUGGLE

#if P_FAMILY_WISPAN
PLACEHOLDER_ANIM_SINGLE_FRAME(Wispan);
PLACEHOLDER_ANIM_SINGLE_FRAME(Panardor);
PLACEHOLDER_ANIM_SINGLE_FRAME(Passianda);
#endif //P_FAMILY_WISPAN

#if P_FAMILY_PACHYDENT
PLACEHOLDER_ANIM_SINGLE_FRAME(Pachydent);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hippugil);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tuscourge);
#endif //P_FAMILY_PACHYDENT

#if P_FAMILY_MARMOSCAMP
PLACEHOLDER_ANIM_SINGLE_FRAME(Marmoscamp);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vermarin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Foolemur);
#endif //P_FAMILY_MARMOSCAMP

#if P_FAMILY_AMPIGEON
PLACEHOLDER_ANIM_SINGLE_FRAME(Ampigeon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Squabolt);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pigenerate);
#endif //P_FAMILY_AMPIGEON

#if P_FAMILY_TOCKTICK
PLACEHOLDER_ANIM_SINGLE_FRAME(Tocktick);
PLACEHOLDER_ANIM_SINGLE_FRAME(Clockroach);
#endif //P_FAMILY_TOCKTICK

#if P_FAMILY_GLEAMITE
PLACEHOLDER_ANIM_SINGLE_FRAME(Gleamite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Glitterfly);
#endif //P_FAMILY_GLEAMITE

#if P_FAMILY_HIBISCUTIE
PLACEHOLDER_ANIM_SINGLE_FRAME(Hibiscutie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dracosnap);
...
#if P_CASTERIAN_FORMS
SINGLE_ANIMATION(SkittyCasterianFeral);
SINGLE_ANIMATION(DelcattyCasterianFeral);
SINGLE_ANIMATION(SkittyCasterianDomestic);
SINGLE_ANIMATION(DelcattyCasterianDomestic);
#endif //P_CASTERIAN_FORMS
#endif //P_FAMILY_SKITTY
#if P_FAMILY_SABLEYE
...
#endif //P_FAMILY_OGERPON
#if P_FAMILY_SHARPUGGLE
SINGLE_ANIMATION(Sharpuggle);
SINGLE_ANIMATION(Pokidna);
SINGLE_ANIMATION(Arquillery);
#endif //P_FAMILY_SHARPUGGLE
#if P_FAMILY_WISPAN
SINGLE_ANIMATION(Wispan);
SINGLE_ANIMATION(Panardor);
SINGLE_ANIMATION(Passianda);
#endif //P_FAMILY_WISPAN
#if P_FAMILY_PACHYDENT
SINGLE_ANIMATION(Pachydent);
SINGLE_ANIMATION(Hippugil);
SINGLE_ANIMATION(Tuscourge);
#endif //P_FAMILY_PACHYDENT
#if P_FAMILY_MARMOSCAMP
SINGLE_ANIMATION(Marmoscamp);
SINGLE_ANIMATION(Vermarin);
SINGLE_ANIMATION(Foolemur);
#endif //P_FAMILY_MARMOSCAMP
#if P_FAMILY_AMPIGEON
SINGLE_ANIMATION(Ampigeon);
SINGLE_ANIMATION(Squabolt);
SINGLE_ANIMATION(Pigenerate);
#endif //P_FAMILY_AMPIGEON
#if P_FAMILY_TOCKTICK
SINGLE_ANIMATION(Tocktick);
SINGLE_ANIMATION(Clockroach);
#endif //P_FAMILY_TOCKTICK
#if P_FAMILY_GLEAMITE
SINGLE_ANIMATION(Gleamite);
SINGLE_ANIMATION(Glitterfly);
#endif //P_FAMILY_GLEAMITE
#if P_FAMILY_HIBISCUTIE
SINGLE_ANIMATION(Hibiscutie);
SINGLE_ANIMATION(Dracosnap);
#endif //P_FAMILY_HIBISCUTIE
