...
enum {
    ...
    NATIONAL_DEX_1024,
    NATIONAL_DEX_1025,
    NATIONAL_DEX_SHARPUGGLE,
    NATIONAL_DEX_POKIDNA,
    NATIONAL_DEX_ARQUILLERY,
    NATIONAL_DEX_WISPAN,
    NATIONAL_DEX_PANARDOR,
    NATIONAL_DEX_PASSIANDA,
    NATIONAL_DEX_PACHYDENT,
    NATIONAL_DEX_HIPPUGIL,
    NATIONAL_DEX_TUSCOURGE,
    NATIONAL_DEX_MARMOSCAMP,
    NATIONAL_DEX_VERMARIN,
    NATIONAL_DEX_FOOLEMUR,
    NATIONAL_DEX_AMPIGEON,
    NATIONAL_DEX_SQUABOLT,
    NATIONAL_DEX_PIGENERATE,
    NATIONAL_DEX_TOCKTICK,
    NATIONAL_DEX_CLOCKROACH,
    NATIONAL_DEX_GLEAMITE,
    NATIONAL_DEX_GLITTERFLY,
    NATIONAL_DEX_HIBISCUTIE,
    NATIONAL_DEX_DRACOSNAP,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_DRACOSNAP
